...
googlemaps.licenseKey("YOUR OWN GOOGLE MAPS KEY");
...
map.addEventListener('idleAtCameraPosition',function(e){
    Ti.API.info("map event : idleAtCameraPosition =>" + JSON.stringify(e));
});
...
map.addEventListener('mapLoaded',function(e){
