...
function makeVK(vk) {
    ...
    vk.makeAPICall = function(method, params) {
        ...
        var url = 'https://api.vk.com/method/{0}?access_token={1}&v=5.53' . format(method, vk.token);
        if (!params) params = {};
    ...
    vk.authorize = function() {
        ...
        var url = 'https://oauth.vk.com/authorize?client_id=' + vk.appid + '&scope=' + psum + '&redirect_uri=https://oauth.vk.com/blank.html&display=mobile&response_type=token&v=5.53';
